...
public class SteamNetworkManager : MonoBehaviour
{
    ...
    private async void SteamFriends_OnGameLobbyJoinRequested(Lobby _lobby, SteamId _id)
    {
    ...
    private void SteamMatchmaking_OnLobbyGameCreated(Lobby _lobby, uint _ip, ushort _port, SteamId _id)
    {
    ...
    private void SteamMatchmaking_OnLobbyMemberLeave(Lobby _lobby, Friend friend)
    {
    ...
    private void SteamMatchmaking_OnLobbyCreated(Result _result, Lobby _lobby)
    {
        ...
        NetworkTransmission.instance.AddMeToDictionaryServerRPC(SteamClient.SteamId, _lobby.Owner.Name, NetworkManager.Singleton.LocalClientId); 
    }
